...
/* 팝업 닫기 */ 
const closePopup = () => {
	tab2popupOverlay.style.display = "none"; // 알림 오버레이 배경 숨김 
	tab3popupOverlay.style.display = "none"; // 회고록 overlay 배경 숨김 
	popup2.style.display = "none";     // 알림 팝업 닫기
	popup3.style.display = "none";     // 회고록 팝업 닫기 
};

// tab2popupOverlay.addEventListener("click", closePopup);   // overlay (창 밖 부분) 클릭 시 팝업 닫힘 
// tab3popupOverlay.addEventListener("click", closePopup);   // overlay (창 밖 부분) 클릭 시 팝업 닫힘 
